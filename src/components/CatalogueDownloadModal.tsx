        ...
        <div className="p-5 overflow-y-auto">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-sm">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-corporate-blue hover:bg-corporate-blue-hover text-white rounded font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-xs mt-1"
